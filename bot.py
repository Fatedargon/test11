...
buyers  = [894849585296580638]  #          
admins  = [894849585296580638]  #   ID users            
owners  = [894849585296580638]  #          
methods = ['HTTP-FLOOD', 'HTTP-RAW', 'HTTP-RAND', 'HTTP-SOCKET','CLOUDFLARE','UAM-BYPASS','SLOW'] # Methods
year_now= datetime.datetime.now().strftime("%Y")     
token   = 'MTA2MzA2NDM1NjI0NzU4ODg4NQ.GX-KqW.cZ-Hc50KkAZ7LzjQk3sqBI9JsjoLdMheXmxv6E' # paste your token here
